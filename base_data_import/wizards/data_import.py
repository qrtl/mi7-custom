...
# io.StringIO stopped working (csv.reader() started to generate an empty object when a
# file generated by io.StringIO is passed to the method) for some unknown reason.
# We therefore switch to use StringIO.StringIO, following the style of base_imort.
# https://github.com/odoo/odoo/blob/28c3f51c4878fbcd79b2e819948465fcf2160ebc/addons/base_import/models/base_import.py#L20-L23  # noqa
# TODO: This part should be reviewed and updated accordingly for Python 3.
try:
    ...
    def _load_import_file(self, field_defs, encodings=None):
        ...
        for encoding in encodings:
            try:
                ...
                csv_iterator = csv.reader(StringIO(csv_data), delimiter=",")
